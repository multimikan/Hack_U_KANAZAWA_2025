  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger asChild>
        <button className="h-10 sm:h-10 px-1 sm:px-4 sm:w-auto rounded-md border border-transparent transition-colors bg-foreground text-background gap-2 hover:bg-[#383838] dark:hover:bg-[#ccc] font-bold text-sm sm:text-sm flex items-center justify-center">
          会員登録
        </button>
      </Dialog.Trigger>
      <Dialog.Portal>
        ...
        >
          <Dialog.Title className="text-lg font-bold">ログイン</Dialog.Title>
